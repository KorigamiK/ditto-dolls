        ...
        <>
            ...
            <div className="py-8 mt-20 bg-white-100">
                <div className="bg-white-50 w-1/2 mx-auto flex flex-col items-center p-8 gap-8">
                    ...
                    {
                        loading ? <p>Loading...</p> : user ? <><p>Welcome {user.displayName}</p> <button onClick={() => auth.signOut()}>Sign out</button>  <Link href={'/dashboard'} >Continue to Dashboard</Link></> :
                            <>
                                ...
                                <button onClick={handleGoogleLogin} className="w-1/2 bg-white-50 text-xl rounded-sm text-center p-3 border border-black/10 -mt-5">
